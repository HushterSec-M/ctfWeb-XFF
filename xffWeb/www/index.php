			...
			<div class="fh5co-tab-content active" data-content="1">
				<div class="fh5co-content-inner text-center">
					<div class="row row-bottom-padded-sm">
						<div class="col-md-12">
							<figure>
								<img style="max-width: 400px;" src="images/profile_img.png" alt="Free HTML5 Wesbite Template by FreeHTML5.co">
							</figure>
							<h1>Ctf Web</h1>
							<p>Are you a professional web developer or a burgeoning amateur? Hence, you want to power a dashboard for some sort of an application or web service? So, don’t lose your time on coding it from scratch. So today, we present 15 most advanced affordable dashboard templates that help you finalize your project within days.</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 fh5co-counter">
							...
							<div class="fh5co-text">
								<h3 class="border-bottom">The first RuCTFE</h3>
								<p>competitions took place online for 10 hours.</p>
							</div>
						</div>
					</div>
